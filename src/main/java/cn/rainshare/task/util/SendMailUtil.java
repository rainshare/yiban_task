...
public class SendMailUtil {
    ...
    static {
        ...
        myEmailSMTPHost = bundle.getString("EmailSMTPHost");
        myEmailAccount = bundle.getString("EmailAccount");
        myEmailPassword = bundle.getString("EmailPassword");
    ...
    public static void sendEmail(String toEmailAddress, String emailTitle, String emailContent) throws Exception{
        ...
        msg.setFrom(new InternetAddress(myEmailAccount,"SERVER", "UTF-8"));
        ...
        //将该邮件保存到本地
        OutputStream out = new FileOutputStream("/root/mail/Email_Unix["+unix+"].eml");
        msg.writeTo(out);
        out.flush();
        out.close();
        transport.close();
